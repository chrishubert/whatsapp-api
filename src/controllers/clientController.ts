 ...
 * @throws Will throw an error if user registration cannot be checked
 */
export const getNumberId = async (req, res) => {
  /*
    #swagger.requestBody = {
      required: true,
      schema: {
 ...
 * @throws {Error} If there is an error while accepting the invite.
 */
export const getWWebVersion = async (req, res) => {
  try {
    const client = sessions.get(req.params.sessionId);
 ...
 * @throws {Error} - Throws an error if the operation fails.
 */
export const getChatsByLabelId = async (req, res) => {
  /*
    #swagger.requestBody = {
      required: true,
      schema: {
 ...
 */
export const addOrRemoveLabels = async (req, res) => {
  /*
  #swagger.requestBody = {
    required: true,
    schema: {
 ...
 */
export const sendPresenceAvailable = async (req, res) => {
  try {
    const client = sessions.get(req.params.sessionId);
 ...
 * @throws {Error} - If there's an error during the presence sending.
 */
export const sendPresenceUnavailable = async (req, res) => {
  try {
    const client = sessions.get(req.params.sessionId);
 ...
 */
export const sendSeen = async (req, res) => {
  /*
    #swagger.requestBody = {
      required: true,
      schema: {
